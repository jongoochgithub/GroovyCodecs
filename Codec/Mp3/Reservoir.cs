...
namespace GroovyMp3.Codec.Mp3
{
    ...
    internal class Reservoir
    {
        ...
        internal BitStream Modules
        {
            set => bs = value;
        }

        internal int ResvFrameBegin(LameGlobalFlags gfp, MeanBits mean_bits)
        {
            ...
            Debug.Assert(0 == gfc.ResvMax % 8);
            Debug.Assert(gfc.ResvMax >= 0);
        ...
        ///             Mark Taylor 4/99
        /// </summary>
        internal int ResvMaxBits(LameGlobalFlags gfp, int mean_bits, MeanBits targ_bits, int cbr)
        {
            ...
            else
            {
                ...
                if (!gfp.disable_reservoir && 0 == (gfc.substep_shaping & 1))
                    targ_bits.bits = (int)(targ_bits.bits - .1 * mean_bits);
            }
        ...
        /// </summary>
        internal void ResvAdjust(LameInternalFlags gfc, GrInfo gi)
        {
        ...
        /// </summary>
        internal void ResvFrameEnd(LameInternalFlags gfc, int mean_bits)
        {
            int over_bits;
            ...
            if (over_bits > 0)
            {
                Debug.Assert(0 == over_bits % 8);
                Debug.Assert(over_bits >= 0);
                stuffingBits += over_bits;
            }
